...
export default function FaqIndex() {
    ...
    const faqs = Array.isArray(data?.data) ? data.data : (Array.isArray(data) ? data : []);

    return (
        <AdminPanelLayout>
            <CreateUpdateFaqModal open={openModal} onOpenChange={setOpenModal} isCreate={isCreate} id={id} />
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <button 
                                                        type="button"
                                                        onClick={() => { setOpenModal(true); setId(faq.id); setIsCreate(false); }}
                                                    ...
                                                    <button 
                                                        type="button"
                                                        onClick={() => { setDeleteId(faq.id); setOpenDeleteModal(true); }}
                                    ...
                                    {faqs.length === 0 && (
                                        <tr>
                                            <td colSpan="4" className="px-6 py-12 text-center">
                                                ...
                                                <p className="text-sm font-medium text-slate-500 dark:text-zinc-400">Belum ada data FAQ</p>
